...
class AppIconService {
  ...
  static const List<AppIconStyle> styles = [
    AppIconStyle(
      'IconDefault',
      'Ulisse',
      [Color(0xff1F526D), Color(0xff08161F)],
      Color(0xffF3C75A),
      'assets/icon_previews/ulisse.png',
      appName: 'CaliTrack',
    ),
    AppIconStyle(
      'IconZeus',
      'Zeus',
      [Color(0xff303B5C), Color(0xff0B0E16)],
      Color(0xffFFD85A),
      'assets/icon_previews/zeus.png',
      appName: 'ZeusTrack',
      premium: true,
      themeId: 'zeus',
    ),
    AppIconStyle(
      'IconCyberpunk',
      'Cyberpunk',
      [Color(0xff320E44), Color(0xff07030D)],
      Color(0xffFF3AD0),
      'assets/icon_previews/cyberpunk.png',
      appName: 'CyberTrack',
      premium: true,
      themeId: 'cyberpunk',
    ),
    AppIconStyle(
      'IconSpartacus',
      'Spartacus',
      [Color(0xffCF4233), Color(0xff1A0A09)],
      Color(0xffE9B45A),
      'assets/icon_previews/spartacus.png',
    ...
    AppIconStyle(
      'IconKratos',
      'Kratos',
      [Color(0xff442727), Color(0xff0E0F12)],
      Color(0xffEE4A40),
      'assets/icon_previews/kratos.png',
      appName: 'KratosFit',
      premium: true,
      themeId: 'kratos',
    ),
    ...
    AppIconStyle(
      'IconSynthwave',
      'Synthwave',
      [Color(0xff2A0A54), Color(0xff0D0221)],
      Color(0xffFF2EC4),
      '',
    ...
    AppIconStyle(
      'IconValkyrie',
      'Valkyrie',
      [Color(0xff2A323B), Color(0xff0B0E12)],
      Color(0xffD7DEE6),
      '',
    ...
    AppIconStyle(
      'IconRonin',
      'Ronin',
      [Color(0xff2E1516), Color(0xff0B0808)],
      Color(0xffC0392B),
      '',
    ...
    AppIconStyle(
      'IconAnubis',
      'Anubis',
      [Color(0xff16233F), Color(0xff070A12)],
      Color(0xffF2C14E),
      '',
    ...
    AppIconStyle(
      'IconAchille',
      'Achille',
      [Color(0xff3A2A12), Color(0xff0C0A08)],
      Color(0xffCF9B3C),
      '',
      glyph: Icons.shield_moon_rounded,
      appName: 'AchilleTrack',
      premium: true,
      themeId: 'achille',
    ),
    AppIconStyle(
      'IconLeonida',
      'Leonida',
      [Color(0xff3A1512), Color(0xff120707)],
      Color(0xffD13B2F),
      '',
      glyph: Icons.security_rounded,
      appName: 'LeonidaTrack',
      premium: true,
      themeId: 'leonida',
    ),
    AppIconStyle(
      'IconPoseidon',
      'Poseidone',
      [Color(0xff0A2A38), Color(0xff04121A)],
      Color(0xff2EC4B6),
      '',
      glyph: Icons.water_rounded,
      appName: 'PoseidonTrack',
      premium: true,
      themeId: 'poseidon',
    ),
    AppIconStyle(
      'IconErcole',
      'Ercole',
      [Color(0xff212E16), Color(0xff0D1109)],
      Color(0xffC9A24B),
      '',
      glyph: Icons.sports_mma_rounded,
      appName: 'ErcoleTrack',
      premium: true,
      themeId: 'ercole',
    ),
    AppIconStyle(
      'IconOdino',
      'Odino',
      [Color(0xff202838), Color(0xff0B0F16)],
      Color(0xffE0B34A),
      '',
    ...
    AppIconStyle(
      'IconRa',
      'Ra',
      [Color(0xff2C1F0C), Color(0xff120C04)],
      Color(0xffF2B418),
      '',
      glyph: Icons.wb_sunny_rounded,
      appName: 'RaTrack',
    ...
    AppIconStyle(
      'IconAde',
      'Ade',
      [Color(0xff1A1226), Color(0xff08060C)],
      Color(0xff7C4DFF),
      '',
    ...
    AppIconStyle(
      'IconCavaliere',
      'Cavaliere',
      [Color(0xff2B3A4D), Color(0xff0D141C)],
      Color(0xff8FA9C8),
      '',
      glyph: Icons.shield_rounded,
      appName: 'CavaliereTrack',
      premium: true,
      themeId: 'cavaliere',
    ),
    AppIconStyle(
      'IconCerberus',
      'Cerberus',
      [Color(0xff3A1C0D), Color(0xff0F0805)],
      Color(0xffFF5A1F),
      '',
      glyph: Icons.pets_rounded,
      appName: 'CerberusTrack',
      premium: true,
      themeId: 'cerberus',
    ),
    AppIconStyle(
      'IconIgris',
      'Igris',
      [Color(0xff3A0F14), Color(0xff0F0507)],
      Color(0xffE0263F),
      '',
      glyph: Icons.military_tech_rounded,
      appName: 'IgrisTrack',
      premium: true,
      themeId: 'igris',
    ),
    AppIconStyle(
      'IconSukuna',
      'Sukuna',
      [Color(0xff3A0D16), Color(0xff0F0407)],
      Color(0xffD81F36),
      '',
      glyph: Icons.face_retouching_natural_rounded,
      appName: 'SukunaTrack',
      premium: true,
      themeId: 'sukuna',
    ),
    AppIconStyle(
      'IconToji',
      'Toji',
      [Color(0xff331014), Color(0xff0D0508)],
      Color(0xffD21F2E),
      '',
      glyph: Icons.colorize_rounded,
      appName: 'TojiTrack',
      premium: true,
      themeId: 'toji',
    ),
