...
class AppIconService {
  ...
  static const List<AppIconStyle> styles = [
    ...
    AppIconStyle('IconCavaliere', 'Cavaliere',
        [Color(0xff2B3A4D), Color(0xff0D141C)], Color(0xff8FA9C8), '',
        glyph: Icons.shield_rounded, appName: 'CavaliereTrack',
        premium: true, themeId: 'cavaliere'),
    AppIconStyle('IconCerberus', 'Cerberus',
        [Color(0xff3A1C0D), Color(0xff0F0805)], Color(0xffFF5A1F), '',
        glyph: Icons.pets_rounded, appName: 'CerberusTrack',
        premium: true, themeId: 'cerberus'),
    AppIconStyle('IconIgris', 'Igris',
        [Color(0xff3A0F14), Color(0xff0F0507)], Color(0xffE0263F), '',
        glyph: Icons.military_tech_rounded, appName: 'IgrisTrack',
        premium: true, themeId: 'igris'),
    AppIconStyle('IconSukuna', 'Sukuna',
        [Color(0xff3A0D16), Color(0xff0F0407)], Color(0xffD81F36), '',
        glyph: Icons.face_retouching_natural_rounded, appName: 'SukunaTrack',
        premium: true, themeId: 'sukuna'),
    AppIconStyle('IconToji', 'Toji',
        [Color(0xff331014), Color(0xff0D0508)], Color(0xffD21F2E), '',
        glyph: Icons.colorize_rounded, appName: 'TojiTrack',
        premium: true, themeId: 'toji'),
  ];
