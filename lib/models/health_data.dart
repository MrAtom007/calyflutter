...
class MetricSeries {
  ...
  double? get latest =>
      today.isNotEmpty ? today.last.value : (daily.isNotEmpty ? daily.last.value : null);

  double? get latest2 =>
      today.isNotEmpty ? today.last.value2 : (daily.isNotEmpty ? daily.last.value2 : null);
